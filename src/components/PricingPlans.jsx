...
const PricingPlans = () => {
  ...
  return (
    <section id='pricing'>
        <div className='max-w-7xl mx-auto px4 mt-20'>
                ...
                className='grid grid-cols-1 md:grid-cols-3 gap-8'>
                    {PLANS_CONTENT.plans.map((plan, index) => (
                        <motion.div key={index}
                            ...
                            ${
                                plan.popular ? "border border-blue-90/80" : "border border-neutral-800"
                            }`}>
                                {plan.popular && (
                                ...
                                <h3 className='text-lg lg:text mb-4 tracking-tighter uppercase'>{plan.name}</h3>
