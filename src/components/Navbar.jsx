    ...
    <nav className='fixed top-4 left-0 right-0 z-50 m-2'>
        ...
        <div className='hidden md:flex space-x-4 items-center'>
            ...
            <div className='md:hidden'>
                <button onClick={toggleMenu} className='text-white focus:outline-none' aria-label={isOpen ? "Close Menu" : "OpenMenu"}>
        ...
        {/* Mobile Menu */}
        {isOpen && (
            <div className='md:hidden bg-neutral-900/60 backdrop-blur-md p-4 mt-2 rounded-xl border border-neutral-800'>
